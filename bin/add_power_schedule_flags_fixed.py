...
flags=Image.open('/home/isaac/editimg_work/jobs/flags.png').convert('RGBA')
...
out='/home/isaac/editimg_work/jobs/power_hours_card_flags_fixed.jpg'; im.convert('RGB').save(out,quality=95,optimize=True); print(out)
